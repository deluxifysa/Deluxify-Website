...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-white/[0.12] bg-[#141416] p-6",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-200 bg-white/80 p-6 backdrop-blur-md",
    },
  },
  defaultVariants: {
    variant: "dark",
...
>(
  (
    ...
    // Always call the hook. conditionally apply below (avoids rules-of-hooks violation)
