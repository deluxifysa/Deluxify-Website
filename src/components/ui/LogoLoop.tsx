...
type ImageLogoItem = { src: string; srcSet?: string; sizes?: string; width?: number; height?: number; alt?: string; title?: string; href?: string };
...
export const LogoLoop = memo(({
  ...
  return (
    <div ref={containerRef} className={rootClass} style={containerStyle as React.CSSProperties}
