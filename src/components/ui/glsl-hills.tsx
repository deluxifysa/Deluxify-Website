          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                // Teal brand color: #2F8F89 = (0.184, 0.561, 0.537)
                // Glow accent: #3FE0D0 = (0.247, 0.878, 0.816)
                float t = clamp(length(vPosition) / 96.0, 0.0, 1.0);
                vec3 teal = vec3(0.184, 0.561, 0.537);
                vec3 glow = vec3(0.247, 0.878, 0.816);
                vec3 color = mix(glow, teal, t);
